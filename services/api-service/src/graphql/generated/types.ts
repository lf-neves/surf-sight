...
export type GraphqlAiInsightsResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['AIInsights'] =
    GraphqlResolversParentTypes['AIInsights'],
> = ResolversObject<{
  conditions?: Resolver<
...
export type GraphqlAiSummaryResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['AISummary'] =
    GraphqlResolversParentTypes['AISummary'],
> = ResolversObject<{
  createdAt?: Resolver<
    GraphqlResolversTypes['DateTime'],
    ParentType,
    ContextType
  >;
  forecast?: Resolver<
    GraphqlResolversTypes['Forecast'],
    ParentType,
    ContextType
  >;
...
export interface GraphqlDateTimeScalarConfig extends GraphQLScalarTypeConfig<
  GraphqlResolversTypes['DateTime'],
  any
> {
  name: 'DateTime';
...
export type GraphqlFavoriteSpotResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['FavoriteSpot'] =
    GraphqlResolversParentTypes['FavoriteSpot'],
> = ResolversObject<{
  createdAt?: Resolver<
    GraphqlResolversTypes['DateTime'],
    ParentType,
...
export type GraphqlForecastResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['Forecast'] =
    GraphqlResolversParentTypes['Forecast'],
> = ResolversObject<{
  createdAt?: Resolver<
    GraphqlResolversTypes['DateTime'],
    ParentType,
  ...
  spotId?: Resolver<GraphqlResolversTypes['ID'], ParentType, ContextType>;
  summaries?: Resolver<
    Array<GraphqlResolversTypes['AISummary']>,
    ParentType,
    ContextType
  >;
  timestamp?: Resolver<
...
export interface GraphqlJsonScalarConfig extends GraphQLScalarTypeConfig<
  GraphqlResolversTypes['JSON'],
  any
> {
  name: 'JSON';
}
...
export type GraphqlMutationResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['Mutation'] =
    GraphqlResolversParentTypes['Mutation'],
> = ResolversObject<{
  _empty?: Resolver<
  ...
  addFavorite?: Resolver<
    GraphqlResolversTypes['FavoriteSpot'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationAddFavoriteArgs, 'spotId'>
  >;
  createAISummary?: Resolver<
    GraphqlResolversTypes['AISummary'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationCreateAiSummaryArgs, 'input'>
  >;
  createForecast?: Resolver<
    GraphqlResolversTypes['Forecast'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationCreateForecastArgs, 'input'>
  >;
  createSpot?: Resolver<
    GraphqlResolversTypes['Spot'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationCreateSpotArgs, 'input'>
  >;
  createUser?: Resolver<
    GraphqlResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationCreateUserArgs, 'input'>
  >;
  deleteAISummary?: Resolver<
    GraphqlResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationDeleteAiSummaryArgs, 'id'>
  >;
  deleteForecast?: Resolver<
    GraphqlResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationDeleteForecastArgs, 'id'>
  >;
  deleteSpot?: Resolver<
    GraphqlResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationDeleteSpotArgs, 'id'>
  >;
  deleteUser?: Resolver<
    GraphqlResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationDeleteUserArgs, 'id'>
  >;
  removeFavorite?: Resolver<
    GraphqlResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationRemoveFavoriteArgs, 'spotId'>
  >;
  updateFavorite?: Resolver<
    GraphqlResolversTypes['FavoriteSpot'],
    ParentType,
    ContextType,
    RequireFields<
      GraphqlMutationUpdateFavoriteArgs,
      'notifyWhatsapp' | 'spotId'
    >
  >;
  updateForecast?: Resolver<
    GraphqlResolversTypes['Forecast'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationUpdateForecastArgs, 'id' | 'input'>
  >;
  updateSpot?: Resolver<
    GraphqlResolversTypes['Spot'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationUpdateSpotArgs, 'id' | 'input'>
  >;
  updateUser?: Resolver<
    GraphqlResolversTypes['User'],
    ParentType,
    ContextType,
    RequireFields<GraphqlMutationUpdateUserArgs, 'id' | 'input'>
  >;
}>;

export type GraphqlQueryResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['Query'] =
    GraphqlResolversParentTypes['Query'],
> = ResolversObject<{
  _empty?: Resolver<
    Maybe<GraphqlResolversTypes['String']>,
    ParentType,
  ...
  >;
  aiSummary?: Resolver<
    Maybe<GraphqlResolversTypes['AISummary']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQueryAiSummaryArgs, 'id'>
  >;
  favorites?: Resolver<
    Array<GraphqlResolversTypes['FavoriteSpot']>,
    ParentType,
    ContextType
  >;
  forecast?: Resolver<
    Maybe<GraphqlResolversTypes['Forecast']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQueryForecastArgs, 'id'>
  >;
  forecastsForSpot?: Resolver<
    Array<GraphqlResolversTypes['Forecast']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQueryForecastsForSpotArgs, 'spotId'>
  >;
  isFavorite?: Resolver<
    GraphqlResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<GraphqlQueryIsFavoriteArgs, 'spotId'>
  >;
  latestAISummary?: Resolver<
    Maybe<GraphqlResolversTypes['AISummary']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQueryLatestAiSummaryArgs, 'spotId'>
  >;
  me?: Resolver<Maybe<GraphqlResolversTypes['User']>, ParentType, ContextType>;
  searchSpots?: Resolver<
    Array<GraphqlResolversTypes['Spot']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQuerySearchSpotsArgs, 'query'>
  >;
  spot?: Resolver<
    Maybe<GraphqlResolversTypes['Spot']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQuerySpotArgs, 'id'>
  >;
  spotBySlug?: Resolver<
    Maybe<GraphqlResolversTypes['Spot']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQuerySpotBySlugArgs, 'slug'>
  >;
  spots?: Resolver<
    Array<GraphqlResolversTypes['Spot']>,
    ParentType,
  ...
  user?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GraphqlQueryUserArgs, 'id'>
  >;
  userByEmail?: Resolver<
    Maybe<GraphqlResolversTypes['User']>,
    ParentType,
    ContextType,
    RequireFields<GraphqlQueryUserByEmailArgs, 'email'>
  >;
  users?: Resolver<
    Array<GraphqlResolversTypes['User']>,
    ParentType,
    ContextType
  >;
}>;

export type GraphqlSpotResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['Spot'] =
    GraphqlResolversParentTypes['Spot'],
> = ResolversObject<{
  aiInsights?: Resolver<
    Maybe<GraphqlResolversTypes['AIInsights']>,
    ParentType,
    ContextType,
    Partial<GraphqlSpotAiInsightsArgs>
  >;
  aiSummary?: Resolver<
    Maybe<GraphqlResolversTypes['AISummary']>,
    ParentType,
    ContextType,
    Partial<GraphqlSpotAiSummaryArgs>
  >;
  createdAt?: Resolver<
    GraphqlResolversTypes['DateTime'],
    ParentType,
  ...
  forecast?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GraphqlSpotForecastArgs, 'nextHours'>
  >;
  id?: Resolver<GraphqlResolversTypes['ID'], ParentType, ContextType>;
  ...
  meta?: Resolver<
    Maybe<GraphqlResolversTypes['JSON']>,
    ParentType,
    ContextType
  >;
...
export type GraphqlSubscriptionResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['Subscription'] =
    GraphqlResolversParentTypes['Subscription'],
> = ResolversObject<{
  _empty?: SubscriptionResolver<
    ...
    ContextType
  >;
  favoriteUpdated?: SubscriptionResolver<
    GraphqlResolversTypes['FavoriteSpot'],
    'favoriteUpdated',
    ParentType,
    ContextType
  >;
  forecastUpdated?: SubscriptionResolver<
    GraphqlResolversTypes['Forecast'],
    'forecastUpdated',
    ParentType,
    ContextType,
    RequireFields<GraphqlSubscriptionForecastUpdatedArgs, 'spotId'>
  >;
}>;

export type GraphqlUserResolvers<
  ContextType = GraphQLContext,
  ParentType extends GraphqlResolversParentTypes['User'] =
    GraphqlResolversParentTypes['User'],
> = ResolversObject<{
  createdAt?: Resolver<
    GraphqlResolversTypes['DateTime'],
    ParentType,
  ...
  >;
  skillLevel?: Resolver<
    Maybe<GraphqlResolversTypes['UserSkillLevel']>,
    ParentType,
    ContextType
  >;
  updatedAt?: Resolver<
