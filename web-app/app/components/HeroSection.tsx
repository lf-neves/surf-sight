        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-600 max-w-2xl mb-3">
              <strong className="text-gray-900">Condições excelentes!</strong>{' '}
              Perfeito para surfistas intermediários e avançados. Clássicas
              direitas do Arpoador com vento offshore.
            </p>
            <div className="flex items-center gap-2 text-sm text-gray-500">
              <Clock className="w-4 h-4" />
              <span>
                Atualizado há 2 min • Melhor janela: Próximas 3 horas • 🇧🇷
                Horário local: 14:15
              </span>
            </div>
          </div>
